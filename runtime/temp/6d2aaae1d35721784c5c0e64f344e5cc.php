<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:96:"C:\phpstudy_pro\WWW\1.2.0.20201008_full\public/../application/admin\command\Install\install.html";i:1602168705;}*/ ?>
<!doctype html>
<html>
<head>
    <meta charset="utf-8">
                        ...
                        success: function (ret) {
                            if (ret.code == 1) {
                                ...
                                if (typeof data.adminName !== 'undefined') {
                                    ...
                                    $('<a class="btn" href="' + url + '" id="btn-admin" style="background:#18bc9c">' + "<?php echo __('Dashboard'); ?>" + '</a>').appendTo($buttons);
                                }
